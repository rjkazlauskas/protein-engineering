...
© 2023-2026 Romas Kazlauskas. All rights reserved. Last revised: September 2026.
...
If the flexible side chain in the product has three rotatable bonds, each of which can adopt three stable conformations, then there are twenty-seven possible microstates ($3 \cdot 3 \cdot 3 = 27$) in the product state. The fixed side chain in the starting material can adopt only one microstate. At 25 °C,
$$ \text{entropy contribution to } \Delta G = -298\text{ K} \cdot 1.987\text{ cal/mol·K} \cdot ln(27/1) = -2.0\text{ kcal/mol} $$
